...
> **Lab pipeline:** this fork adds experiment-oriented processing under [`lab/`](lab/). See [LAB.md](LAB.md) for the layout and how to run it. Upstream suite2p documentation follows.
